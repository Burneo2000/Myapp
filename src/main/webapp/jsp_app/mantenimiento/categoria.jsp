<%-- 
    Document   : index
    Created on : 11 dic. 2020, 09:34:31
    Author     : Alexander Oré
--%>
...
<html class="no-js" lang="es">
    ...
    <head>
        ...
        <link href="../css_app/view/view.css" rel="stylesheet" type="text/css"/>
        <!-- modernizr css -->
                                    ...
                                    <form id="frmCategoria">
                                        <div class="row campo">
                                            <div class="form-group col-sm-9 col-12">
                                                <input type="text" id="txtNombreCategoria" name="separacion" class="form-control form-control-sm" placeholder="NOMBRE">
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="btnBuscrCategoria" class="btn btn-primary btn-xs"><i class="fa fa-search" aria-hidden="true"></i> BUSCAR</button>
                                                <button type="button" id="btnAbirNCategoria" class="btn btn-primary btn-xs derecha"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
